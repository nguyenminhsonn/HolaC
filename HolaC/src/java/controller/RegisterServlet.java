...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Account a = db.check(u, p);

        if (u.isEmpty() || p.isEmpty() || name.isEmpty() || email.isEmpty() || phone.isEmpty() || address.isEmpty()) {
            ...
            if (a != null || db.checkUser(u) == true) {
                ...
                db.create(new Account(u, p, 0));
                db.addCustomerInfo(new Customer(u, name, email, phone, address));
